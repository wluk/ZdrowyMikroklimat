                    ...
                    function(e) {
                        ...
                        if (warningsFound) {
                            ...
                            if ($.isFunction(settings.options.submitError)) {
                                settings.options.submitError($form,
                                    e,
                ...
                return this.each(function() {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minchecked") !== undefined) {
                            message = "Not enough options checked; Minimum of '" +
                        ...
                        if ($this.attr("maxchecked") !== undefined) {
                            message = "Too many options checked; Maximum of '" +
                    ...
                    do // repeatedly expand 'shortcut' validators into their real validators
                    {
                        ...
                        $.each(validatorNamesToInspect,
                            function(i, el) {
                                if ($this.data("validation" + el + "Shortcut") !== undefined) {
                                    // Are these custom validators?
                                    // Pull them out!
                                    $.each($this.data("validation" + el + "Shortcut").split(","),
                                        function(i2, el2) {
                                ...
                                function(validatorType, validatorTypeArray) {
                                    if (value ||
                                        ...
                                        (!!settings.validatorTypes[validatorType].blockSubmit &&
                                            params &&
                                            !!params.submitting)) {
                                        $.each(validatorTypeArray,
                                            function(i, validator) {
                                                if (settings.validatorTypes[validatorType].validate($this,
                                                    value,
                                                    validator)) {
                    ...
                    $this.bind(
                        ...
                        function(e, params) {
                            ...
                            $controlGroup.find("input,textarea,select").each(function(i, el) {
                                ...
                                $.each($(el).triggerHandler("validation.validation", params),
                                    function(j, message) {
                            ...
                            $form.find("input,select,textarea").not($this).not("[name=\"" + $this.attr("name") + "\"]")
                            ...
                            if (errorsFound.length) {
                                ...
                                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                    ...
                                    $helpBlock.html("<ul role=\"alert\"><li>" +
            ...
            hasErrors: function() {
                ...
                this.each(function(i, el) {
                    errorMessages = errorMessages.concat(
                        ...
                        ? $(el).triggerHandler("validation.validation", { submitting: true })
                        : []
                    );
                });
                        ...
                        executeFunctionByName(
                            ...
                            function(data) {
                                if (rrjqbvValidator.lastValue === data.value) {
                                    ...
                                    rrjqbvThis.data("validation" + rrjqbvValidator.validatorName + "Message",
            ...
            match: {
                ...
                init: function($this, name) {
                    var element = $this.parents("form").first()
                        .find("[name=\"" + $this.data("validation" + name + "Match") + "\"]").first();
